...
public class StartApplic {
    public static void main(String[] args) {
        ...
        IRepository<Student, Integer> repoStudent = new Repository.StudentRepositoryInFile("C:\\Users\\alex.salajan\\faculta.git\\vvssLab2\\src\\Resources\\Studenti.txt", validatorStudent);
        Validator<Tema> validatorTema = new ValidatorTema();
        IRepository<Tema, Integer> repoTema = new
                Repository.TemaRepositoryInFile("C:\\Users\\alex.salajan\\faculta.git\\vvssLab2\\src\\Resources\\Teme.txt", validatorTema);
